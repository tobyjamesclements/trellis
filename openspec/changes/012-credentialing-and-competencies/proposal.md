# Change: 012 Credentialing and competencies
...
- Credential transfer into the consumer-realm backpack (CRD-16), used by
  change 013's portability flows.

## Impact

- Adds the CRD-defined fact types to the registry (see spec §Domain model).
- Consumes `effect.ready` kind `credential` (008).
...
003, 005, 008, 009. Standards certification for OB 3.0 requires the
