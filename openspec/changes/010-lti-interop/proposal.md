# Change: 010 LTI interoperability
...
- Consumes `effect.ready` intents of kind `ags_score` (008) and adds the
...
003 (sessions, roles), 005 (structure placements), 007 (activities to
launch and grade), 008 (folds and intents), 009 (notifications for
failures). The Caliper endpoint claim points at 011's endpoint; until 011
