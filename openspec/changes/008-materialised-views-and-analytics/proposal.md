# Change: 008 Materialised views and analytics
...
- `view-updater` (Java with the GraalJS-hosted engine) consuming SQS FIFO `views` with HWM-cursor folding,
...
002, 003, 005, 006. Activities (007) produce the facts the views fold;
views can be verified with synthetic facts before 007.

## Out of scope

Emitters that consume `effect.ready` (009, 010, 011, 012).
