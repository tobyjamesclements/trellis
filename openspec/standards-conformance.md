...
| **OpenID Connect Core / OAuth 2.0** | RP (login); AS for LTI services and OB3 API | Conformant | OP for general use | Single-use state per region; stateless tokens | IDE-02, 03; LTI-03 |
...
| **WCAG 2.2 AA** | All UIs and authored content checks | AA | — | — | CAC, ACT, IDE |
